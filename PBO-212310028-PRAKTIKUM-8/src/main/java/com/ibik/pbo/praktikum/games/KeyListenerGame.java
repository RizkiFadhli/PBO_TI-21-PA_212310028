...
public class KeyListenerGame extends JFrame implements KeyListener {
    ...
    private ImageIcon icon_bebek_up, icon_bebek_down, icon_bebek_right, icon_bebek_left;
    ...
    private void GenerateGamesUI(KeyListenerGame frame) {
        ...
        m_up = KeyListenerGame.class.getClassLoader().getResource(images_path + "bebek_up.png");
        m_down =  KeyListenerGame.class.getClassLoader().getResource(images_path + "bebek_down.png");
        m_left = KeyListenerGame.class.getClassLoader().getResource(images_path + "bebek_left.png");
        m_right = KeyListenerGame.class.getClassLoader().getResource(images_path + "bebek_right.png");

        // Initialize icon
        icon_bebek_up = new ImageIcon(m_up);
        icon_bebek_down = new ImageIcon(m_down);
        icon_bebek_left = new ImageIcon(m_left);
        icon_bebek_right = new ImageIcon(m_right);
        
        lbl_img = new JLabel();
        lbl_img.setBounds(100, 100, 364, 456);
        lbl_img.setIcon(icon_bebek_right);
